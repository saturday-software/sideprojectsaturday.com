/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 41ab6ac50456ef1711c3dc4185eb7eb0)
// Runtime types generated with workerd@1.20260415.1 2026-04-11 global_fetch_strictly_public
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "EventDO" | "MailboxDO";
	}
	interface Env {
		CACHE: KVNamespace;
		...
		EVENT_ADDRESS: "325 Gold St #503";
		BSKY_IDENTIFIER: "sideprojectsaturday.com";
		ADMIN_PASSWORD: string;
		SHARE_SEED: string;
		EVENT_DO: DurableObjectNamespace<import("./src/worker").EventDO>;
		MAILBOX_DO: DurableObjectNamespace<import("./src/worker").MailboxDO>;
	}
}
